...
namespace SistemaVentaAngular.Controllers
{
    ...
    public class VentaController : ControllerBase
    {
        ...
        public async Task<IActionResult> Reporte(string? fechaInicio, string? fechaFin)
        {
            ...
            DateTime _fechaInicio = DateTime.ParseExact(fechaInicio, "dd/MM/yyyy", new CultureInfo("es-EC"));
            DateTime _fechaFin = DateTime.ParseExact(fechaFin, "dd/MM/yyyy", new CultureInfo("es-EC"));
